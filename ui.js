...
export function toggleVisuals() {
  graphsSection.classList.toggle('active');
  accuracySection.classList.toggle('active');
}

export function showPredictionVisuals() {
  imagesSection.classList.toggle('active');
}
